'''
    ...
    Input:
        ...
        games. Then follows n lines, one line for each game,
        containing the name of the player getting points for the game
        and the points earned, separated by space.
